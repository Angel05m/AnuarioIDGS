...
<style>
  ...
  .toolbar .search input{
    ...
    background:#fff;
    color:#0f172a;
    border:none; /* usa el borde del contenedor .search */
    border-radius:.95rem;
...
@section('content')
  @if(session('success'))
    <div class="mb-6 rounded-2xl p-4 flex items-center bg-white/80 border border-emerald-200">
  ...
  <div class="toolbar mb-8">
    <form id="filters" method="GET" action="{{ route('publications.index') }}" class="flex items-center gap-3 flex-wrap w-full">
      {{-- Buscador --}}
  ...
  <div class="page-bg -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-8 rounded-2xl">
    @if($publications->isEmpty())
      <div class="rounded-3xl p-16 text-center border border-white/10 bg-white/5 backdrop-blur-sm">
      ...
      <div id="publications-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        @foreach($publications as $publication)
          @php
            ...
            // Fecha a mostrar: fecha_publicacion si existe, si no created_at
            ...
            <div class="rounded-xl overflow-hidden bg-white">
              ...
              <div class="relative h-64 overflow-hidden group">
                ...
                <div class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity
                  ...
                  <!-- Editar solo si es el dueño y estamos en "Mis publicaciones" -->
              ...
              <div class="p-6 text-slate-900">
                ...
                {{-- Autor y fecha (usa fecha_publicacion si existe, si no created_at) --}}
